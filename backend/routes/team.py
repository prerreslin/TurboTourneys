...
@team_router.post("/create_team", status_code=status.HTTP_201_CREATED, summary = "Creating The Team")
...
@team_router.get("/team/{team_name}", response_model=TeamScheme, summary="Get Team Info")
